...
describe Dashboard::Action do
  ...
  context '#active_for' do
    ...
    let!(:action_for_published_proposal) { create :dashboard_action, :active, day_offset: 0, required_supports: 0, published_proposal: true }
    let!(:action_for_draft_proposal) { create :dashboard_action, :active, day_offset: 0, required_supports: 0, published_proposal: false }
