...
describe Dashboard::Mailer do
  ...
  describe "#new_actions_notification_on_create" do
    ...
    it "sends emails when detect new actions when create a proposal" do
      ...
      expect(email).to have_body_text("When you are ready publish your citizen proposal from this link.")
      ...
      expect(email).to have_body_text("Enter every day in the panel of your proposals to use the tips and resources that we will share with you.")
