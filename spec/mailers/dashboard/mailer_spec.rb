...
describe Dashboard::Mailer do
  ...
  describe "#new_actions_notification_on_create" do
    ...
    it "sends emails when detect new actions when create a proposal" do
      ...
      expect(email).to have_body_text("When you are ready publish your citizen proposal from this <a href='http://test/proposals/1-proposal-1-title/dashboard'>link</a>.")
